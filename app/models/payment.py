...
class CryptoPayment(SQLModel, table=True):
    ...
    price_amount: Decimal = Field(max_digits=18, decimal_places=8)
    price_currency: str = Field(max_length=10)
    pay_amount: Optional[Decimal] = Field(default=None, max_digits=18, decimal_places=8)
    pay_currency: Optional[str] = Field(default=None, max_length=10)
    actually_paid: Optional[Decimal] = Field(default=None, max_digits=18, decimal_places=8)
    ...
    outcome_amount: Optional[Decimal] = Field(default=None, max_digits=18, decimal_places=8)
